...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold">Artiest aanmaken</h1>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            <form action="{{ route('artists.store') }}" method="post" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="country" id="country" required class="mt-1 block w-full border rounded px-3 py-2">
                </div>

                <div>
                    <label for="bio" class="block text-sm font-medium text-gray-700">Biografie</label>
                    <textarea name="bio" id="bio" class="mt-1 block w-full border rounded px-3 py-2" rows="4"></textarea>
                </div>


                <div class="pt-4">
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Artiest aanmaken</button>
