...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Log in op je account om het dashboard te bekijken.</p>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 max-w-md">
            <form action="{{ route('login') }}" method="post" class="space-y-4">
                ...
                <div class="pt-4">
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Inloggen</button>
